...
console.log("line 18 "+page,req.method)
    if(page=="/"){
...
req.on('end',function(){
    ...
    customers.addOne(userData.name, userData.user_name, userData.email,userData.Password,userData.mobile_number,userData.address, userData.dob, (err,result)=>{
var context ={
    result:{
    success:true,
    errors:[]
